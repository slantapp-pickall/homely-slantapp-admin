              ...
              <Col md="6" xl="5">
                <ProjectCard>
                  <div className="project-head">
                    ...
                    >
                      <UserAvatar className="sq" theme="primary" text={findUpper("Homely Dev")} />
                      <div className="project-info">
                        <h6 className="title">Homely Development</h6>
                  ...
                  <div className="project-details">
                    Design and develop the Homely template for Envato Marketplace.
                  </div>
