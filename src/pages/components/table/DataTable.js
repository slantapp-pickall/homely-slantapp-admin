          ...
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className="lead">
                ...
                for further understanding. The plugin has been customized for the purpose of React Homely.
              </p>
            </BlockDes>
          </BlockHeadContent>
        </BlockHead>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Just import <code>ReactDataTable</code> from <code>components</code>, it is built in for react homely.
              </p>
            </BlockHeadContent>
          </BlockHead>
