...
const InvoiceDetails = () => {
  ...
  return (
    <React.Fragment>
      ...
      {user && (<Content>
        <BlockHead size="lg">
          <div className="nk-block-head-sub"><Link className="back-to" to={`${process.env.PUBLIC_URL}/invoices`}><Icon name="arrow-left"/><span>Invoices</span></Link></div>
          <BlockBetween>
            <BlockHeadContent>
                  ...
                  <div className="table-responsive">
                    <table className="table table-striped">
                      ...
                      <tbody>
                        <tr>
                          <td>24108054</td>
                          <td>Homely - Conceptual App Dashboard - Regular License</td>
