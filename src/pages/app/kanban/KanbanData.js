export const columnData = {
  task: {
    "task-1": {
      ...
      desc: "Start implementing new design in coding @homely",
      meta: {
        users: [{ value: "Sara Dervashi", label: "Sara Dervashi", theme: "light" }],
        tags: [
          { value: "Homely", label: "Homely", theme: "info" },
    ...
    "task-2": {
      id: "task-2",
      title: "Homely React Version",
      desc: "Implement new UI design in react version @homely template as soon as possible.",
      meta: {
    ...
    "task-3": {
      id: "task-3",
      title: "Homely Design Kit Update",
      desc: "Update the new UI design for @homely template with based on feedback.",
      board: "In Progress",
      meta: {
